...
**** Desktop Applications
     ...
     - [[https://classic.youneedabudget.com/][YNAB]] (disabled by default, I use the online version)
...
**** Command line tools
     ...
     - [[http://s3tools.org/s3cmd][s3cmd]] (disabled by default, I use the AWS CLI now)
